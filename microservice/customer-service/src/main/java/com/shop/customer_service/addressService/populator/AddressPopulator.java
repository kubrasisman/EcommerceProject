...
public abstract class AddressPopulator {
    ...
    @Mapping(target = "owner", expression = "java(findCustomer())")
    ...
    protected CustomerModel findCustomer() {return customerRepository.findByEmail(UserUtil.current()).orElseThrow(()-> new RuntimeException("Current User Not Found"));}
}
