package com.shop.order_service.cache.services.impl;
...
public class DefaultCacheService implements CacheService {
    ...
    public Object extendCache(String prefix, String key, long ttl_hours, TimeUnit timeUnit) {
        String fullKey = keyBuilder(prefix, key);
        log.debug("CACHE: Extending TTL for key: {}, TTL: {} {}", fullKey, ttl_hours, timeUnit);
        return redisTemplate.expire(fullKey, ttl_hours, timeUnit);
    }
